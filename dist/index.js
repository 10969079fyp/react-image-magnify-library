...
const ReactImageMagnify = (props) => {
    ...
    const [magnifierShape, setMagnifierShape] = React.useState('circle');
    const [largeImageLoaded, setLargeImageLoaded] = React.useState(false);
...
const ReactImageMagnifier = (props) => {
    ...
    const [showMagnifier, setShowMagnifier] = React__namespace.useState(false);
    const [magnifierX, setMagnifierX] = React__namespace.useState(0);
    const [magnifierY, setMagnifierY] = React__namespace.useState(0);
    const [zoomLevel, setZoomLevel] = React__namespace.useState(initialZoomLevel);
    const [zoomMode, setZoomMode] = React__namespace.useState(false);
